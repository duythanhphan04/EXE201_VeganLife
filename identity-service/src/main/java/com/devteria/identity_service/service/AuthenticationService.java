...
public class AuthenticationService {
    ...
    public AuthenticationResponse outboundAuthenticate(String code){
     ...
     public AuthenticationResponse refreshToken(RefrestTokenRequest request) throws ParseException, JOSEException {
     ...
     private SignedJWT verifyToken(String jwt, boolean isRefresh) throws JOSEException, ParseException {
