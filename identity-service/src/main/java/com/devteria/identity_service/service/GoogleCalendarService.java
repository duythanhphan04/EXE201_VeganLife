...
public class GoogleCalendarService {
    ...
    public String createGGMeetAppointment(CreateAppointmentRequest request,
                                          String userEmail,
        ...
        try {
            ...
            EventDateTime start = new EventDateTime()
                    .setDateTime(new com.google.api.client.util.DateTime(DateTimeFormatter.ISO_INSTANT.format(instant)))
                    .setTimeZone(VIETNAM_ZONE.toString());
            EventDateTime end = new EventDateTime()
                    .setDateTime(new com.google.api.client.util.DateTime(DateTimeFormatter.ISO_INSTANT.format(instant.plusSeconds(60 * 60))))
                    .setTimeZone(VIETNAM_ZONE.toString());
