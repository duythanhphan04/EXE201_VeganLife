...
public class ResourcesController {
    ...
    public ApiResponse<ResourcesResponse> createResources(@Valid @RequestBody CreateResourcesRequest request) {
    ...
    public  ApiResponse<List<ResourcesResponse>> getResourcesByStatus( @PathVariable ResourcesStatus status) {
    ...
    public ApiResponse<ResourcesResponse> updateResources(@PathVariable String resourceId, @Valid @RequestBody UpdateResourcesRequest request) {
