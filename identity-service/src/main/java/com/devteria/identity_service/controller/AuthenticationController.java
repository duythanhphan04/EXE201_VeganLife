...
public class AuthenticationController {
    ...
    ApiResponse<AuthenticationResponse> outboundAuthenticate(@Parameter(description = "Authorization code từ Google redirect",in = ParameterIn.QUERY, required = true)@RequestParam("code") String code){
    ...
    ApiResponse<AuthenticationResponse> refreshToken(@RequestBody RefrestTokenRequest request) throws ParseException, JOSEException {
